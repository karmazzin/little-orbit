...
export function dialogue(id:ResidentId,s:Story,topic='greeting'):Dialogue{
 if(topic==='world')return {text:'Мы называем это место Тихой долиной. Иди куда захочешь: рано или поздно вернёшься сюда с другой стороны. А у брода выше по течению вода совсем неглубокая.',choices:[{text:'Пойду осмотрюсь'}]};
 if(id==='mira'){
