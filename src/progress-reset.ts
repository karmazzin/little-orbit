...
export const PROGRESS_KEYS=['story','world','residents','exploration','camp','content','adventures','azure-story','azure-beacon','frontier','known-journeys','tracked-journey'].map(id=>`little-orbit-${id}-v1`);
